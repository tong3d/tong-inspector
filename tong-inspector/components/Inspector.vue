...
<template>
    <el-collapse v-model='actives'>
        ...
        <div v-if="inspectors.bottomButton">
            <div :style="{'margin':inspectors.bottomButton.maginTop===undefined?4:inspectors.bottomButton.maginTop+'px'}"></div>
            <el-row >
                <el-button  style="width:100%"  :span="24" @click="inspectors.bottomButton.callback===undefined?()=>{}:inspectors.bottomButton.callback($event)">{{inspectors.bottomButton.name}}</el-button>
            </el-row>
        </div>
    </el-collapse>
</template>
